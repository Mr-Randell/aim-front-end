      ...
      <div className="grid grid-cols-1  sm:grid-cols-3 lg:grid-cols-4 gap-6 sm:px-8 px-5 py-16">
        ...
        <form action="">
          <div className="relative z-0 mb-6 w-full group">
            <div className="text-white w-full p-2 flex items-center justify-between" onClick={()=> setOpen(!open)}>
            ...
            <ul className={`bg-white mt-2 overflow-y-auto ${open ? "max-h-60 " : "max-h-0"}`}>
              ...
              <li key={id} className="p-2 text-sm hover:bg-sky-500 hover:text-white"
              onClick={()=>{
